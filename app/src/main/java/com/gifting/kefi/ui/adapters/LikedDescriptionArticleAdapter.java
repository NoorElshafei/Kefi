...
public class LikedDescriptionArticleAdapter extends RecyclerView.Adapter<LikedDescriptionArticleAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Article2Model> articlesModels;


    public LikedDescriptionArticleAdapter(Context context, ArrayList<Article2Model> articlesModels) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.rootItem.setOnClickListener(v -> {
            Intent intent = new Intent(context.getApplicationContext(), ArticleDetails2Activity.class);
