...
public class FaceProductAdapter extends RecyclerView.Adapter<FaceProductAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Products> products;


    public FaceProductAdapter(Context context) {
        this.context = context;
        products = new ArrayList<>();
    }

    public void setVideoModels(ArrayList<Products> products) {
