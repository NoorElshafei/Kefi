...
public class FaceVideoAdapter extends RecyclerView.Adapter<FaceVideoAdapter.ViewHolder> {

    private Context context;
    private ArrayList<VideoModel> videoModels;


    public FaceVideoAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context.getApplicationContext()).load(videoModels.get(position).getImage()).apply(new RequestOptions().override(211, 120)).into(holder.binding.itemImage);
