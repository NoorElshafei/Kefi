...
public class LikedTipsArticleAdapter extends RecyclerView.Adapter<LikedTipsArticleAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Article2Model> articlesModels;


    public LikedTipsArticleAdapter(Context context, ArrayList<Article2Model> articlesModels) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(articlesModels.get(position).getImageView()).into(holder.binding.itemImage);
