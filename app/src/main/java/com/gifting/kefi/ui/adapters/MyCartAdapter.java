...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    public MyCartAdapter(Context context, TotalCartInterFace totalCarts) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.deleteItem.setOnClickListener(v -> {
                db.userDao().delete(roomCartsList.get(position));
    ...
    private void updateProduct(int changeNumber, int position, ViewHolder holder) {
        ...
        db.userDao().updateCart(roomCartsList.get(position).getId(), roomCartsList.get(position).getQuantity());
    ...
    */
    ...
    public void add(RoomCarts roomCarts) {
        ...
        totalCarts.addToTatal(roomCarts.getPrice().intValue() * roomCarts.getQuantity());
