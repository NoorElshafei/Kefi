package com.gifting.kefi.ui.fragments.add_comment_reel_video;
...
import com.gifting.kefi.ui.fragments.add_comment_youtube_video.AddCommentVideoViewModel;
...
public class AddCommentReelVideoFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public static AddCommentReelVideoFragment newInstance() {
        return new AddCommentReelVideoFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments().getString("reelVideoModelId") != null) {
            videoId = getArguments().getString("reelVideoModelId");
    ...
    private void addCommentToFirebase() {
        if (!binding.commentEditText.getText().toString().isEmpty()) {
            ...
            mViewModel.getSuccessText().observe(getViewLifecycleOwner(), success -> {
                ...
                ((VideoDetailsActivity) getActivity()).updateComment();
