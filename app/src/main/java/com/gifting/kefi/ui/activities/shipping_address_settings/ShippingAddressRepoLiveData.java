...
public class ShippingAddressRepoLiveData extends LiveData<ArrayList<AddressModel>> {
    ...
    public ShippingAddressRepoLiveData(Query query) {
        this.query = query;
    }

    public ShippingAddressRepoLiveData(DatabaseReference ref) {
        this.query = ref;
